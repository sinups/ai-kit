...
VISUAL_FILTER='^(inputbar|tools-edittool)--' yarn test:visual:baseline
VISUAL_FILTER='^(inputbar|tools-edittool)--' yarn test:visual package/src/input/InputBar.story package/src/tools/EditTool.story
```
