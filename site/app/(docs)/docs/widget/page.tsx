      ...
      <GuideSection id="options" title="Options">
        <DocTable
          ...
          rows={[
            ...
            [<C key="o">iconAnimation</C>, <C key="d">none</C>, "none, circle, coin, flip: with an avatar the two faces alternate, without one the icon itself turns or grows."],
            [<C key="o">pulse</C>, <C key="d">false</C>, "Slow rings around the closed button."],
            [<C key="o">ringColor</C>, "color", "Color of the rings and of the halo around the open button."],
