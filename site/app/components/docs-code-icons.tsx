  ...
  if (ext === "css") {
    return (
      <svg viewBox="0 0 32 32" className={cls}>
        ...
        />
        <path
          d="M24.381 25.475l1.92-21.518H16V27.86l8.381-2.385z"
          fill="#2965f1"
        />
        <path
          d="M10.03 13.221L10.314 16.37 16 16.37 16 13.221 10.03 13.221zM16 7.058 15.989 7.058 9.463 7.058 9.697 9.713 16 9.713 16 7.058zM16 24.577L16 21.3 15.986 21.304 13.168 20.543 12.988 18.523 11.55 18.523 10.23 18.523 10.585 22.496 15.986 23.995 16 23.991 16 24.577z"
          fill="#ebebeb"
        />
        <path
          d="M21.968 16.37L22.328 12.339 22.433 11.166 16 11.166 16 13.221 15.984 13.221 20.178 13.221 19.906 16.37 16 16.37 16 18.523 19.717 18.523 19.717 18.523 19.366 22.496 16 23.398 16 25.534 21.411 24.036 21.451 23.587 22.071 16.635 22.136 15.92 21.968 16.37z"
          fill="#fff"
        />
      </svg>
    );
